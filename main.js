...
bot.onText(/\/start/, (msg) => {
  ...
  "👋 Привет! Ты подписан на Whale Watch!\n" +
    "Буду присылать тебе сделки китов по выбранным сетям.\n\n" +
    "📌 Команды:\n" +
    "• /threshold 1000 — изменить минимальную сумму (минимум $100)\n" +
    "• /setkey <chain> <wss-url> — задать свой WebSocket RPC endpoint для сети\n" +
    "   Чтобы получить wss-URL, сделай так:\n" +
    "   1. Зарегистрируйся на Alchemy (https://www.alchemy.com/) или Blast (https://blastapi.io/).\n" +
    "   2. Создай новое приложение (app) для нужной сети (Ethereum, Arbitrum, Polygon или BSC).\n" +
    "   3. Скопируй WebSocket URL вида:\n" +
    "      wss://eth-mainnet.g.alchemy.com/v2/ВАШ_КЛЮЧ\n" +
    "   4. Введи команду, например:\n" +
    "      /setkey eth wss://eth-mainnet.g.alchemy.com/v2/ВАШ_КЛЮЧ\n\n" +
    "• /block 0x... — добавить токен в личный блок-лист\n" +
    "• /unblock 0x... — удалить токен из личного блок-листа\n" +
    "• /status — показать текущие настройки (порог, ключи и блок-лист)\n\n" +
    "⏳ Пока ты не введёшь хотя бы один `/setkey`, уведомления не будут приходить.",
    { parse_mode: "Markdown" },
  );
});
